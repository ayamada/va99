...
()=>t(e.createBuffer(1,2,e.sampleRate),0,1),{once:!0}));var B={L:async a=>{var b=await fetch(a);if(!b.ok)throw Error(a);a=await b.arrayBuffer();return await D.decodeAudioData(a)},P:t,BGM:w,D:r,l:y,get V(){return x},set V(a){x=a;l&&(l.gain.value=a)},get A(){return e},VER:"va99-5.0.20230925"};return B})();
