...
a;f.h=d;d.start()}else v()}},w=(a,b=0,c=1,h=1,m=1,k=0,d=!1)=>{d||=a;var g=f.h,n=f.j;if(!g?.buffer||f.g||d!==n[0]||b!=n[2]||m!=n[3]||h!=n[4]||k!=n[5])if(u++,null==a||a instanceof AudioBuffer){if(f.i=a?[d,a,b,m,h,k]:null,!f.g){if(!g?.buffer||!g.G||!c)return v();f.g=!0;var z=99*c,F=g.G.gain.value/9,A=()=>0>=(g.G.gain.value-=F)||!g.buffer?v():setTimeout(A,z);setTimeout(A,z)}}else{w(null,!1,c);var G=u;B.L(a).then(C=>C&&G==u&&w(C,b,c,h,m,k,d))}};y(0);["click","touchstart","touchend"].forEach(a=>document.addEventListener(a,
()=>t(e.createBuffer(1,2,e.sampleRate),0,1),{once:!0}));var B={L:async a=>{var b=await fetch(a);if(!b.ok)throw Error(a);a=await b.arrayBuffer();return await D.decodeAudioData(a)},P:t,BGM:w,D:r,I:y,get V(){return x},set V(a){x=a;l&&(l.gain.value=a)},get A(){return e},VER:"va99-5.1.20230925"};return B})();
